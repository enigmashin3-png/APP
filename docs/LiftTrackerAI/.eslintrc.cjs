module.exports = {
  ...
  overrides: [
    {
      files: ["**/*.{js,jsx,ts,tsx}"],
      excludedFiles: ["styles/themes.css", "tailwind.config.*", "**/*.d.ts"],
      rules: {
        ...
        "regex/invalid": [
          ...
          [
            ...
            {
              regex:
                "\\b(?:text|bg|border)-(?:red|blue|green|emerald|amber|orange|yellow|purple|pink|rose|cyan|teal|indigo)-(?:[1-9]00)\\b",
