      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h2 className="text-lg font-semibold">
            {workoutId ? `Logging: ${workoutId}` : "Start a Workout"}
          </h2>
          <span className="rounded-full bg-slate-900/10 px-2 py-0.5 text-xs text-slate-700">
            Auto-save
          </span>
        </div>
        <button onClick={onExit} className="text-sm text-slate-600 hover:text-slate-900">
          Exit
        </button>
      </div>
