...
const templates: Template[] = [
  {
    id: "t1",
    title: "PHAT Back and s...",
    exercises: ["Seated Overhead Press (Barbell)", "Seated Overhead ..."],
    date: "Dec 9, 2023",
  },
  {
    id: "t2",
    title: "PHAT legs hypertrophy",
    exercises: ["Squat (Barbell)", "Bulgarian Split Squat, Cross Body..."],
    date: "Sep 2, 2023",
  },
  {
    id: "t3",
    title: "PHAT chest and triceps",
    exercises: ["Bench Press (Barbell)", "Incline Bench Press (Barb..."],
    date: "Feb 18, 2025",
  },
  {
    id: "t4",
    title: "PHAT Lower body",
    exercises: ["Squat (Barbell)", "Hack Squat (Barbell), Lunge (D..."],
    date: "Jun 29, 2022",
  },
];
